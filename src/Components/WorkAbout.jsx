            ...
            <section>
                <div className="container my-[100px] mx-auto">
                    <div className='flex flex-wrap gap-[40px] md:gap-2 lg:gap-5 justify-center'>
                        <div className='md:basis-[30%] flex flex-col gap-2 text-center items-center border-2 md:px-[10px] py-[30px] border-transparent duration-300 ease-in-out rounded-md hover:border-black hover:bg-slate-300'>
                        ...
                        <div className='md:basis-[30%] flex flex-col gap-2 text-center items-center border-2 py-[30px] border-transparent duration-300 ease-in-out rounded-md hover:border-black hover:bg-slate-300'>
