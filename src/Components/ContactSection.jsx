                    ...
                    <div className='flex justify-between gap-2 flex-wrap'>
                        ...
                        <div className='shadow-lg p-10 basis-[100%] lg:basis-[47%]'>
                            <form action="" className=' basis-[60%] flex flex-wrap justify-between gap-2'>
                                ...
                                <input type="text" className='bg-slate-100 outline-none px-2 border-2 py-2 border-slate-200 rounded-sm basis-[100%] duration-300 ease-in-out hover:border-black' placeholder='Your Phone' />
